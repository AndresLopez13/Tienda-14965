...
const[clientes,setClientes]=useState([]);
  ...
  const facturar = async (e) => {
    try {
      ...
      console.error("Ocurrió un error al generar la Nota de Venta:", error);
  ...
  const updateFactura = async (e) => {
    try {
      ...
      navigate("/impresion");
      alert("Nota de Venta ingresada correctamente");
...
/>
            ...
            >
              Enviar Detalle a la Nota de Venta {"  "}
